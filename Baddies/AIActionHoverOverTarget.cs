...
namespace MoreMountains.CorgiEngine
{
    ...
    public class AIActionHoverOverTarget : AIAction
    {
        ...
        protected virtual void Fly()
        {
            ...
            if (this.transform.position.y < (_brain.Target.position.y + HoverHeight))
            {
            ...
            if (Mathf.Abs(this.transform.position.y - (_brain.Target.position.y + HoverHeight)) < MinimumDistance)
            {
        ...
        public override void OnEnterState()
        {
            ...
            _characterFly.FlySpeed = 15f;
        }

        protected void PlayHoverSfx()
        {
            SoundManager.Instance.PlaySound(HoverSfx, transform.position);
        }
    }
}
