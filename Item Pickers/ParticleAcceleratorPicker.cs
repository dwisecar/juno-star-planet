...
{
    public class ParticleAcceleratorPicker : PickableItem
    {
        ...
        protected override void Pick()
        {
            ...
            _characterInventory.EquipWeaponOnPickup("InventoryParticleAccelerator");
            //if we haven't already obtained it
            if (!GameManager.Instance.ParticleAcceleratorObtained)
            {
                if (!GameManager.Instance.DebugMode) { RunSplashScreen(); }
                GameManager.Instance.ParticleAcceleratorObtained = true;
        ...
        protected override void RunSplashScreen()
        {
            ...
            GUIManager.Instance.StartItemCollected("MuonBeam");
