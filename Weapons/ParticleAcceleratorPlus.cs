...
namespace MoreMountains.CorgiEngine
{
    ...
    /// </summary>
    [SelectionBase]
    public class ParticleAcceleratorPlus : Weapon
    {
        [Header("Position")]
        ...
        {
            base.WeaponUse();
            LucyHandleWeapon.ShootingParticleAcceleratorPlus = true;
        ...
        public override void WeaponInputStop()
        {
            ...
            LucyHandleWeapon.ShootingParticleAcceleratorPlus = false;
